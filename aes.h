...
public:
    ...
    std::string encrypt(const std::string& data) {
        ...
        EVP_EncryptInit_ex(ctx, EVP_aes_256_cbc(), nullptr, reinterpret_cast<const unsigned char*>(this->key.c_str()), nullptr);
    ...
    std::string decrypt(const std::string& ciphertext) {
        ...
        EVP_DecryptInit_ex(ctx, EVP_aes_256_cbc(), nullptr, reinterpret_cast<const unsigned char*>(this->key.c_str()), nullptr);
